...
<header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto active" href="#hero">Inscription</a></li>
            </ul>
...
<div class="section-title">
    <h2>Inscrivez-vous</h2>
        ...
        <form method="post" action="inscriptionbdd.php">
            ...
            Code Postale : <input name="cp" id="cp" type="text" placeholder="CP"><br/>
            ...
            Nom d'utilisateur : <input type="text" name="nom_utilisateur" placeholder="Entrez votre nom d'utilisateur" /><br />
            Email : <input type="email" name="mail" placeholder="Entrer votre Email" /><br />
