...
<header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1 class="text-light"><a href="index.php"><span>VigoAvio</span></a></h1>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#portfolio">Mise a jour d'un vol</a></li>
                <li><a class="nav-link scrollto" href="#team">Suppresion d'un vol</a></li>
                <li><a class="nav-link scrollto" href="#contact">Bienvenue <?php echo $_SESSION['nom_utilisateur'] ?></a></li>
            </ul>
